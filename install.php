...
if (file_exists($db_file)){
	...
	$db->exec("create table addons (id integer primary key, author text, name text, summary text, description text, url text, legacy integer default 0, hidden integer default 0)");
	$db->exec("create table links (id integer, file text unique, version text, channel text, minimum text, lasttested text, link text, downloads integer, modified text, hidden integer default 0)");
